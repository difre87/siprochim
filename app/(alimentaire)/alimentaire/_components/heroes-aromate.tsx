...
const HeroesAromate = () => {
  ...
  return (
    <>
      <section className="w-full min-h-screen relative  bg-bamboo">
        ...
        <div className="w-full h-[100px] bg-[#e5bd83] absolute bottom-0"></div>
            ...
            <div className="w-full grid md:grid-cols-4 sm:grid-cols-1 sm:px-14 md:py-0 gap-10 py-20 ">
              ...
              >
                <motion.div
                  initial={{ transform: "translateX(-100px)", opacity: 0 }}
                  whileInView={{ transform: "translateX(0px)", opacity: 1 }}
                  transition={{ type: "spring", ease: "linear", duration: 3.5 }}
